  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      body: Center(
          child: Column(
        children: [
          Text("Select a minimum rating\nranging from 1-10",
              style: theme.textTheme.headline5, textAlign: TextAlign.center),
          const Spacer(),
          Row(
            mainAxisAlignment: MainAxisAlignment.center,
            children: [
              Text("${ref.watch(movieFlowControllerProvider).rating}",
          ...
          const Spacer(),
          PrimaryButton(onPressed: ref.watch(movieFlowControllerProvider.notifier).nextPage, text: "Yes Please"),
          const SizedBox(
